...
const isValidCharacter = (letter) => {
    for (let individualCharacter of validCharacters) {
        if(letter === individualCharacter){
            return true;
        }
    }
...
const isValidWord = (word) =>{
    ...
    while (low <= r ){
        ...
        //Checks if word is at midpoint in array
        if (spellCheckWords[mid] == word.toLowerCase()){
            return true;
        }   
        //If word is greater, ignore lower half
        if (spellCheckWords[mid] < word.toLowerCase()){
            low = mid + 1;
        }
...
function getRandomWord(){
    ...
    console.log(playWords[randomIndex].toUpperCase());
    return playWords[randomIndex].toUpperCase();
}

export { isValidCharacter, getRandomWord, isValidWord} 